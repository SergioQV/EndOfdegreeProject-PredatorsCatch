...
namespace Opsive.UltimateCharacterController.Demo.Objects
{
    ...
    public class Door : MonoBehaviour
    {
        ...
        {
            if (!MathUtility.InLayerMask(other.gameObject.layer, m_LayerMask) || (other.gameObject.GetCachedParentComponent<UltimateCharacterLocomotion>() == null && other.gameObject.tag != "aliado")) {
                return;
            }
